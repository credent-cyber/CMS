    ...
    <div className={styles.requestsTabWrap}>
      <div className={styles.requestsToolbar}>
        ...
        <Autocomplete
          ...
          options={helpdeskContactOptions}
          value={helpdeskContactFilter === "All" ? null : helpdeskContactFilter}
          onChange={(_event, newValue) => handleHelpdeskContactFilterChange(newValue)}
