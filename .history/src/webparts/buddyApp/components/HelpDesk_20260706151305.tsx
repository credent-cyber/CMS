...
//   );
  ...
  const filteredRequestRows = useMemo(() => {
    const baseRows = myPendingOnly && !isElevatedUser ? myPendingBucketRows : requestRows;
  ...
  }, [requestRows, myPendingBucketRows, myPendingOnly, isElevatedUser, helpdeskContactFilter, statusFilter]);
